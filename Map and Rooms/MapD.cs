...
namespace Roguelike_2
{
    class MapD : Map
    {
        ...
        //public void AddMonster(List<Enemy> enemy)
        //{
        //    SetIsWalkable(enemy.mx, enemy.my, false);
        ...
        //    SetIsWalkable((int)enemy.x, (int)enemy.y, true);
        //    Game.SchedulingSystem.Remove(enemy);
        //}

        //public Enemy GetMonsterAt(int x, int y)
        //{
        //    return enemy.FirstOrDefault(m => m.x == x && m.y == y);
        //}
        ...
        //        if (cell.IsWalkable)
        //        {
        //            console.Set(cell.X, cell.Y, 'k', Colors.FloorBackgroundFov, '.');
        //        }
        //        else
        //        {
        ...
        //        if (cell.IsWalkable)
        //        {
        //            console.Set(cell.X, cell.Y, null, null, '.');
        //        }
        //        else
        //        {
